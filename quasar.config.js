  ...
  return {
    ...
    build: {
      ...
      rawDefine: {
        ...
        DEV: JSON.stringify(ctx.dev),
        PROD: JSON.stringify(ctx.prod),
        LOCAL: JSON.stringify(process.env.NODE_LOCAL === 'local'),
      },
    ...
    pwa: {
      ...
      extendManifestJson(json) {
        json.name = 'ExprTool'
        json.short_name = 'Expression Tool'
        json.description = 'flespi micro-front expression tool'
