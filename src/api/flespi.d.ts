...
export type TFlespiRegions = { [name: string]: TFlespiRegion }
export type TRequestMethods = 'GET' | 'POST' | 'PUT' | 'DELETE' | 'PATCH'
export type TFlespiAclSubmodule = {
  methods: TRequestMethods[],
  name: string
}
export type TFlespiAcl = {
  ids: Array<number>,
  methods: TRequestMethods[],
...
export type TFlespiTokenAccess = {
  acl?: TFlespiAcl[],
  type: EFlespiTokenType
}
export type TFlespiTokenInfo = {
  access: TFlespiTokenAccess,
  cid: number,
  created: number,
  expire: number,
  id: number,
...
export type TFlepsiLoginModel = { token: string, region: TFlespiRegion }
export interface IFlespiResponse<R, E> {
  result: R[],
  errors?: E[]
}
export type TFlespiMessage = {
  [param: string]: unknown
}
export type TFlespiError = {
  code: number,
  reason: string
}
export type TTimezonesNames = `${ETimezones}`
export type TFlespiExprData = {
  expression: string,
...
export type TFlespiExprValidationModel = {
  ...
  index: number,
  result?: unknown,
  error?: TFlespiExprDataError
}
export type TFlespiExprError = TFlespiError & {
  column?: number
}
export type TFlespiExprValidationResponse = IFlespiResponse<TFlespiExprValidationModel, TFlespiError>
export type TFlespiExprFunction = {
